...
#define DEBUG_CONTROL_PACKET_PART_CMD      1
...
#define DEBUG_REPLY_PACKET_PART_CMD      1
...
#define DEBUG_PACKET_CMD_TYPE_SHFT   7
#define DEBUG_PACKET_CMD_TYPE_MASK   (1 << DEBUG_PACKET_CMD_TYPE_SHFT)
#define DEBUG_PACKET_CMD_TYPE_GET    0
#define DEBUG_PACKET_CMD_TYPE_SET    1
#define DEBUG_PACKET_CMD_GET_RPM     0x01
#define DEBUG_PACKET_CMD_GET_RECORD  0x21
#define DEBUG_PACKET_CMD_SET_RECORD  0xA1
